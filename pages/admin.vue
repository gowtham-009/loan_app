            ...
            <div class="w-100 pa-2">
              ...
              <div class="w-100 boxex-2 pa-2":style="{height:boxex2Height + 'px'}">
                ...
                <div class="loan-2 w-100 d-flex  ga-10 justify-center align-center  " >
                  <v-checkbox class="text-h6" label="Daywise"></v-checkbox>
                  <v-checkbox class="text-h6" label="0.5 Month"></v-checkbox>
                  <v-checkbox class="text-h6" label="1 Month"></v-checkbox>
                </div>
                  ...
                  <v-card>
                    <v-sheet class="w-100 pa-2">
                      ...
                      <div class="w-100 pa-1">
                        <p>[2] Extra 3 Days after 1 Month will be calculated as ?</p>
                        <div class="loan-2 w-100 d-flex  ga-10 justify-center align-center" >
                      ...
                      <div class="w-100 d-flex mt-2">
                        <div class="w-100">
                          <p>[3] How many months of Initial <br> Interest Deducation?(Type in Months)</p>
                        </div>
                        <div class="w-100">
                          <v-text-field
                            :counter="10"
                      ...
                      <div class="w-100 mt-2">
                        <p>[10] Do you need value handover calculation?</p>
                        <div class="loan-2 w-100 d-flex  ga-10 justify-center align-center  " >
